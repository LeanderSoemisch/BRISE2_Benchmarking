...
This module provides functionality to load HTML templates and their associated
...
class TemplateLoader:
    """Load and manage HTML templates with CSS and JavaScript assets."""
    ...
    def __init__(self, templates_dir: str = None):
        ...
        Args:
            templates_dir: Directory containing templates. Defaults to utils/templates/
        """

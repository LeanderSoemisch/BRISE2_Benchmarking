...
function updateDimensions() {
    var width = parseFloat(document.getElementById('export-width').value);
    var height = parseFloat(document.getElementById('export-height').value);
...
function applyPreset() {
    var presetKey = document.getElementById('preset-select').value;
...
function performExport() {
    var plotDiv = currentExportConfig.plotDiv;
    var filename = currentExportConfig.fileName;

    // Clone the plot configuration
    var exportLayout = JSON.parse(JSON.stringify(plotDiv.layout));
